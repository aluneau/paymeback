...
<html lang="en-us">
    <head>
        <meta charset="utf-8"/>
        <link rel="stylesheet" href="pong.css" type="text/css" media="screen"
              />
        <script type="text/javascript">var lightSpeed = 10;
...
Game.prototype.end = function () {
    ...
    if (this.endGameDiv.style.display === "none"){
        ...
        if (this.player.score > this.iaPlayer.score){
            this.endGameDiv.firstChild.innerHTML = "Victory ! </br> <a href='../../defiForm.php?score=" + (this.player.score+this.iaPlayer.score) + "&jeu=pong'>Defier</a>";
            this.endGameDiv.firstChild.style.color = "green";
        }
        else if(this.player.score < this.iaPlayer.score){
            this.endGameDiv.firstChild.innerHTML = "Defeat ! </br> <a href='../../defiForm.php?score=" + (this.player.score+this.iaPlayer.score) + "&jeu=pong'>Defier</a>";
...
{
        if ((this.player.score+this.iaPlayer.score)> scoreToWin)
        {            this.endGameDiv.firstChild.innerHTML = "Victory !";
            this.endGameDiv.firstChild.style.color = "green";

                            var xhr = getXMLHttpRequest(); // Voyez la fonction getXMLHttpRequest() définie dans la partie précédente
                            xhr.open("GET", "../../mailGain.php?jeu=pong&mail=<?php echo $_GET['mail'];?>&mail2=<?php echo $_GET['mail2'];?>", true);
                            xhr.send(null);
        }
        else
        {            this.endGameDiv.firstChild.innerHTML = "Defeat !";
                this.endGameDiv.firstChild.style.color = "red";
                            ...
                            var xhr = getXMLHttpRequest(); // Voyez la fonction getXMLHttpRequest() définie dans la partie précédente
                            xhr.open("GET", "../../mailLose.php?jeu=pong&mail=<?php echo $_GET['mail'];?>&mail2=<?php echo $_GET['mail2'];?>", true);
                            xhr.send(null);
        }
    }
...
/******************************************************************************/
    ...
    <body class="body" onload="load(1, 3)">
        <div id="gameBoard">
            <div id="player" class="Block Paddle"></div>
            <div id="ia" class="Block Paddle"></div>
            <div id="ball" class="Block"></div>
            <div id="playerScore" class="score"><p>0</p></div>
            <div id="iaScore" class="score"><p>0</p></div>
            <div id="endGame"><p></p>
				<input type="submit" class="btn" id="buttonAgain" name="again" value="Again ?"/></div>
        </div>
    </body>
</html>
