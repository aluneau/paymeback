...
function loose(){
	...
	if(scoreToWin == -1)
	{
			...
			htmlString4+= '<a href="../../defiForm.php?score='+ score + '&jeu=tetris"' + ' class="button alert round"type="button">Defier</a>'
	...
	document.getElementById("gameEnd").innerHTML += "<div id='TryorDice' class='zoom-anim-dialog mfp-hide'> " + scoreToWin + "</div>";
